...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  //focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background TAILWIND PROPERTIES REMOVED TO REMOVE FOCUS RING
